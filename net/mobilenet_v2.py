...
class MobileNetV2():
    ...
    def build_mobilenetv2(self, _inputs, num_class, is_train, keep_prob):
        with tf.variable_scope('mobilenetv2'):
            ...
            res2 = inverted_res_block(conv1, 16, (3, 3), t=1, strides=1, is_train=is_train, n=1, name='res2')
            res3 = inverted_res_block(res2, 24, (3, 3), t=6, strides=2, is_train=is_train, n=2, name='res3')
            res4 = inverted_res_block(res3, 32, (3, 3), t=6, strides=2, is_train=is_train, n=3, name='res4')
            res5 = inverted_res_block(res4, 64, (3, 3), t=6, strides=2, is_train=is_train, n=4, name='res5')
            res6 = inverted_res_block(res5, 96, (3, 3), t=6, strides=1, is_train=is_train, n=3, name='res6')
            res7 = inverted_res_block(res6, 160, (3, 3), t=6, strides=2, is_train=is_train, n=3, name='res7')
            res8 = inverted_res_block(res7, 320, (3, 3), t=6, strides=1, is_train=is_train, n=1, name='res8')
